...
class MLP(object):
	...
	# Here is where I've (GP) modified the code to include a second hidden 
	# layer with equal numbers of units as the previous layer.
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=10, batch_size=20, n_hidden=5000):
    """
    Demonstrate stochastic gradient descent optimization for a multilayer
    perceptron

    This is demonstrated on CIFAR-10 (first 10,000).
   ...
   """
    ...
    classifier = MLP(rng=rng, input=x, n_in=d.n_in,
                     n_hidden=n_hidden, n_out=d.n_out)
