...
class HyperparametersDBN(Hyperparameters):
    def __init__(self, learningRate=0.1, numberEpochs=1000, batchSize=10, patience = 5000, patienceIncrease = 2, improvementThreshold = 0.995, pretrainingEpochs = 100, pretrainingLearningRate=0.01, k=1):
        Hyperparameters.__init__(self, learningRate, numberEpochs, batchSize, patience, patienceIncrease, improvementThreshold)
